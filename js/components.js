...
},{}],"prod-components":[function(require,module,exports){
'use strict';
...
var ListOfPingStat = function (_React$Component) {
    _inherits(ListOfPingStat, _React$Component);

    function ListOfPingStat(props) {
        _classCallCheck(this, ListOfPingStat);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ListOfPingStat).call(this, props));
    ...
    _createClass(ListOfPingStat, [{
        ...
        key: 'updateListContents',
        value: function updateListContents(pingStatPropsList) {
                ...
                return(
                    ...
                    React.createElement(
                        ...
                        this.state.pingStatPropsList.map(function (pingStatProps) {
                            return React.createElement(PingStat, _extends({}, pingStatProps, {
...
var PingStat = function (_React$Component2) {
    _inherits(PingStat, _React$Component2);

    function PingStat() {
        _classCallCheck(this, PingStat);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(PingStat).apply(this, arguments));
    }

    _createClass(PingStat, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                'div',
                { className: 'pingstat' },
                React.createElement(PingStatBar, this.props),
                React.createElement(PingStatVideoLink, this.props),
                React.createElement(PingStatDateTime, this.props)
            );
        }
    }]);
...
var PingStatBar = function (_React$Component3) {
    _inherits(PingStatBar, _React$Component3);

    function PingStatBar() {
        _classCallCheck(this, PingStatBar);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(PingStatBar).apply(this, arguments));
    }

    _createClass(PingStatBar, [{
        key: 'render',
        value: function render() {
            ...
            for (var i = 0; i < numEmptyBoxes; i++) {
                boxesMarkup.push(React.createElement('div', { className: 'pingstatbarbox', key: i }));
            }
            for (var i = numEmptyBoxes; i < this.props.numBoxesToDisplay; i++) {
                boxesMarkup.push(React.createElement('div', { className: 'pingstatbarbox filled', key: i }));
            }
            return React.createElement(
                'div',
                { className: 'pingstatbar', title: this.calculateApproxTimeWatched() },
                boxesMarkup
            );
        }
    }, {
        key: 'calculateNumFilledBoxes',
        value: function calculateNumFilledBoxes() {
        ...
        key: 'calculateApproxTimeWatched',
        value: function calculateApproxTimeWatched() {
        ...
        key: 'formatDurationStr',
        value: function formatDurationStr(n, unit) {
            if (n === 1) {
                return n + ' ' + unit;
            } else {
                return n + ' ' + unit + 's';
        ...
        key: 'SECONDS_PER_PING',
        value: function SECONDS_PER_PING() {
            return 5;
        }
    }]);
...
var PingStatVideoLink = function (_React$Component4) {
    _inherits(PingStatVideoLink, _React$Component4);

    function PingStatVideoLink() {
        _classCallCheck(this, PingStatVideoLink);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(PingStatVideoLink).apply(this, arguments));
    }

    _createClass(PingStatVideoLink, [{
        key: 'render',
        value: function render() {
            var videoUrl = 'https://www.youtube.com/watch?v=' + this.props.youtubeId;
            return React.createElement(
                'div',
                { className: 'pingstatvideolink' },
                React.createElement(
                    'a',
...
var PingStatDateTime = function (_React$Component5) {
    _inherits(PingStatDateTime, _React$Component5);

    function PingStatDateTime() {
        _classCallCheck(this, PingStatDateTime);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(PingStatDateTime).apply(this, arguments));
    }

    _createClass(PingStatDateTime, [{
        key: 'render',
        value: function render() {
...
},{"jquery":"jquery","moment":1,"react":"react"}]},{},[]);
